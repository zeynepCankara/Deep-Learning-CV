...
def EvaluateImages(gt_dir, pred_dir):
    img_gt_paths = []
    img_pred_paths = []
    for i in range(100):
        img_name = "{}.jpg".format(401 + i)
        img_name2 = "{}.jpg".format(401 + i)
        img_gt_paths.append(os.path.join(gt_dir, img_name))
        img_pred_paths.append(os.path.join(pred_dir, img_name2))
...
def main():
    ...
    mse, ssim = EvaluateImages(args.g, args.p)
