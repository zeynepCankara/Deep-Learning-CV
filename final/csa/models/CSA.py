...
class CSA(BaseModel):
    ...
    def set_input(self,input,mask):
        # im = transforms.ToPILImage()(mask[0].cpu()*255).convert("RGB")
        # im.save('{}/ex_mask2.png'.format(self.opt.checkpoints_dir))
        ...
        # print(self.input_A.min(), self.input_A.max())
        ...
        # self.input_A.narrow(1,0,1).masked_fill_(self.mask_global, -1)
        # self.input_A.narrow(1,1,1).masked_fill_(self.mask_global, -1)
        # self.input_A.narrow(1,2,1).masked_fill_(self.mask_global, -1)
    ...
    def forward(self):
        ...
        # print("aaaa")
        # print(self.inv_ex_mask[0].min(), self.inv_ex_mask[0].max())
        # print(self.ex_mask[0].min(), self.ex_mask[0].max())
        # im2 = transforms.ToPILImage()(self.ex_mask[0].cpu()*255).convert("RGB")
        # im2.save('{}/ex_mask.png'.format(self.opt.checkpoints_dir))
    ...
    def get_current_visuals(self,fake=False):
